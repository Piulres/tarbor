                ...
                <tr data-entry-id="{{ $income->id }}">
                    <td field-key='income_category'>{{ $income->income_category->name or '' }}</td>
                                ...
                                <td field-key='amount'>{{ $income->amount }}</td>
                                                                <td>
                                    @can('view')
                                    <a href="{{ route('incomes.show',[$income->id]) }}" class="btn btn-xs btn-primary">@lang('global.app_view')</a>
                                    @endcan
                                    @can('edit')
                                    <a href="{{ route('incomes.edit',[$income->id]) }}" class="btn btn-xs btn-info">@lang('global.app_edit')</a>
                                    @endcan
                                    @can('delete')
{!! Form::open(array(
